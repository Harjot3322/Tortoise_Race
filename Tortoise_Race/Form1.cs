...
private void TransparentBackground()
        ...
        private void GuyRadioButtons()
        {
            ...
            myGuy[0].MyRadioButton.Text = "Jon";
            myGuy[1].MyRadioButton.Text = "Ali";
            myGuy[2].MyRadioButton.Text = "Josh";
        }

        private void LBLs()
        {
            myProperty.LBLJon = myProperty.NotBetYet;
        ...
        private void GuyNotBetYet()
        {
            ...
            lblJoe.Text = myGuy[0].GuyName + myProperty.LBLJon;
            myGuy[1].MyRadioButton = radioButton2;
            lblSam.Text = myGuy[1].GuyName + myProperty.LBLAli;
...
private void IsWinner()
            ...
            for (myProperty.Guy = 0; myProperty.Guy < 3; myProperty.Guy++)
            {
                ...
                else
                {
                    ...
                    if (myGuy[myProperty.Guy].MaxCash == 0)
                    {
                        ...
                        {
                            myProperty.LBLJon = myProperty.Busted;
                            lblJoe.Text = myGuy[0].GuyName + myProperty.LBLJon;
        ...
        {
            if (myProperty.LBLJon == " you have run out of Cash! BUSTED!" && myProperty.LBLAli == " you have run out of Cash! BUSTED!" && myProperty.LBLJosh == " you have run out of Cash! BUSTED!")
            {
